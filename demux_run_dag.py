    ...
    def build_dragen_cmds(sample_sheet, sequencer_and_run):
        ...
        for sample, project in sample_dict.items():
            ...
            if sample_sheet.sample_dict[sample] == "HumanWholeGenome":
                ...
                dragen_cmd_1 = "/opt/edico/bin/dragen --ref-dir /staging/ref/GRCh38_graph --qc-coverage-ignore-overlaps=true --enable-duplicate-marking true --enable-map-align-output true "
