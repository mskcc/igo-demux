...
class LaunchMetrics(object):
	...
	def dragen_rna_alignment_and_metrics(sample, run, sample_parameters, rna_directory, work_directory, fastq_list):
		...
		bsub_launch_dragen_rna = "bsub -J {0}{1} -o {0}{1}.out -cwd \"{2}\" -m \"id01 id03\" -q dragen -n 48 -M 4 {3}".format(rna_dragen_job_name_header, sample.sample_id, rna_directory, launch_dragen_rna)
	...
	def dragen(sample, run, sample_parameters, work_directory, dragen_directory, fastq_list):
		...
		bsub_launch_dragen = "bsub -J {0}{1} -o {0}{1}.out -cwd \"{2}\" -m \"id01 id03\" -q dragen -n 48 -M 4 {3}".format(dragen_job_name_header, sample.sample_id, dragen_directory, launch_dragen)
	...
	def dragen_methylation(sample, run, sample_parameters, work_directory, dragen_directory, fastq_list):
		...
		bsub_launch_dragen = "bsub -J {0}{1} -o {0}{1}.out -cwd \"{2}\" -m \"id01 id03\" -q dragen -n 48 -M 4 {3}".format(dragen_methylation_job_name_header, sample.sample_id, dragen_directory, launch_dragen_methylation)
		print(bsub_launch_dragen)
		call(bsub_launch_dragen, shell = True)
