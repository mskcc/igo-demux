# read in csv stats files generated by DRAGEN alignment and create Picard format txt files that can be parsed into NGS database
import pandas as pd
import sys
import os
...
class DragenStats:
    ...
    def read_info_from_csv(self, folder_path):
        ...
        # TODO read DRAGEN version from the "-replay.json" file such as:
        # RUTH_0123_BHM3MLDSX3___P05816_DR___FL005-202EOT_IGO_05816_DR_19-replay.json

    # create ___AM.txt picard stats format file
    # requirments: 7 lines minimum, line with data need to start with Category PAIR, file name ends with ___AM.txt
    def write_to_am_txt(self, output_path):
        ...
        with open(write_to_file, 'w') as _file:
            _file.write("#DRAGEN_VERSION_01.003.044.3.10.1-183-g9ced7ae8 " + self.sample_name + "\n")
            for i in range(6):
                _file.write("#\n")
            _file.write(data_line)

    # create ___MD.txt picard stats format file
    ...
    # create ___WGS.txt picard stats format file
