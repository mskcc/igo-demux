...
class PostStatsToIgodbAndLims:
	...
	def post_data_files(self, run):
		...
		move_all_data_files = "python3 /igo/work/igo/igo-demux/scripts/move_all_data_files.py {}".format(done_directory)
		...
		# move all data file to the work directory
		push_data_to_ngs_and_lims = "python3 /igo/work/igo/igo-demux/scripts/push_data_to_ngs_and_lims.py {} {}".format(sequencer, run)
